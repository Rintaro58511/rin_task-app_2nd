...
@pytest.mark.anyio
async def test_delete_subtask(monkeypatch, task, subtask, override_get_db):
...
@pytest.mark.anyio
async def test_delete_none_task(monkeypatch, subtask, task, override_get_db):
...
@pytest.mark.anyio
async def test_delete_none_subtask(monkeypatch, subtask, task, override_get_db):
...
@pytest.mark.anyio
async def test_delete_other_task(monkeypatch, subtask, task, other_task, override_get_db):
