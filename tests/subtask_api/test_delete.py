...
async def test_delete_subtask(
    monkeypatch, task, subtask, override_get_db, override_get_current_user
):
...
async def test_delete_none_task(
    monkeypatch, subtask, task, override_get_db, override_get_current_user
):
...
async def test_delete_other_task(
    monkeypatch, subtask, task, other_task, override_get_db, override_get_current_user
):
